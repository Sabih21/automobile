      ...
      <tbody>
          @foreach ($vehicle as $vehicle)
              <tr>
                  ...
                  <td>
                    <a href="{{ route('vehicles.edit', ['vehicle' => $vehicle->VehicleID]) }}" class="btn btn-primary">Edit</a>

                       <!-- Delete Button -->
          <form action="{{ route('vehicles.destroy', ['vehicle' => $vehicle->VehicleID]) }}" method="post" style="display:inline;">
            @csrf
            @method('DELETE')
