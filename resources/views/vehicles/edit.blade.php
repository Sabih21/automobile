                        ...
                        <form method="POST" action="{{ route('vehicles.update', $vehicle->VehicleID) }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Amount" class="form-control" value="{{ $vehicle->Amount }}"
                                        required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="images[]" value="{{$vehicle->images}}" class="form-control-file" multiple>
                                </div>
                            ...
                            @foreach ($images as $image)
                             <img src="{{asset('storage/' . $image->image_path) }}" width="250px" alt="Vehicle Image" class="existing-image">
                                @endforeach
                              </div>
                                </div>
                            @endif
