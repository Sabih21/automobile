                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="regis_no" class="form-control" placeholder="Registration No.">
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="car_touchups" class="form-control" placeholder="Touch Ups">
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="balance_inspection">Car Inspection</label>
                                <input type="text" name="balance_inspection" class="form-control" placeholder="Car Inspection">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="owner_address" class="form-control" placeholder="Address">
                            </div>
