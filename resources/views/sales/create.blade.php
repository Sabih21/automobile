            ...
            <div class="container-fluid">
                <div class="row justify-content-center align-items-center">
                    <div class="col-sm-8 text-center my-auto">
                        <h1 style="font-weight:bold">Sales Order</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="customer_id" class="form-control" required>
                                        @foreach ($customers as $customer)
                                            <option value="{{ $customer->id }}">{{ $customer->name }}- Cnic No -
                                                {{ $customer->cnic_no }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="serial_of_reg_challan">Serial # of Reg
                                        Challan</label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="owner_name">Installment No of months</label>
                                    <input type="number" name="no_of_installment" class="form-control"
                                        placeholder="Installment">
                                </div>
                                {{-- <div class="mb-3">
                                    <label class="form-label" for="owner_name">Installment Amount</label>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="owner_name">Paid Amount</label>
                                    <input type="number" name="paid_amount" class="form-control"
                                        placeholder="paid_amount of installment">
                                </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="sale_cplc_image[]" class="form-control"
